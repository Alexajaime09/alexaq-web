...
const Services = () => {
  return (
    ...
    >
      <h2 className="  my-[20px]  font-kumb  text-[30px]  md:text-[38px]  lg:text-4xl tracking-title">
        SERVICES
      </h2>

      <div className="flex flex-wrap lg:flex-row justify-around items-start w-full h-auto gap-10 ">
        <div
